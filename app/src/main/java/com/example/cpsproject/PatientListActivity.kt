...
import com.example.cpsproject.managers.ClinicianManager.name
...
class PatientListActivity : AppCompatActivity() {
    ...
    var itemAdapter:PatientAdapter?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter!!.setData(listAllPatients)
                ...
                override fun onQueryTextChange(newText: String?): Boolean {
                    if (newText!!.isNotEmpty()) {
                        ...
                        for (patient in listPatients) {
                            if (patient.name?.toLowerCase(Locale.getDefault())
                                    ?.contains(search) == true || patient.surname?.toLowerCase(Locale.getDefault())
                        ...
                        displayList.clear()
                        displayList.addAll(listPatients)
                    }
